export function transformToPremisesCreateRequest(data, reoId) {
...
export function transformToIncomePlanCreateRequest(data, reoId) {
    return data.map((item) => ({
        reo_id: reoId,
        property_type: item['Property type'] ?? '', // Provide default if undefined
...
export function mapPremisesToRealEstateObjectData(premises) {
...
export function mapIncomePlanToIncomePlanData(incomePlans) {
