...
function PreviewIncomeData({ data }) {
    ...
    const formatValue = (value, header) => {
        ...
        if (header === 'period_begin' || header === 'period_end') {
            return (_jsx("span", { className: styles.dateCell, children: String(value) }));
        }
